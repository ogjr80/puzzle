...
@Component({
    ...
    template: `
        ...
        [ngStyle] = "{display: name.value === '' ? 'none': 'block'}">
            ...
            <p>Ok, welcome <span class="name">{{name.value}}</span></p><br>
            Switch 1: 
            <input type="text" value=1 #switch1 (keyup)="0"><br>
            Switch 2: 
            <input type="text" value=1 #switch2 (keyup)="0"><br>
            Switch 3: 
            <input type="text" value=1 #switch3 (keyup)="0"><br>
            Switch 4: 
            <input type="text" value=1 #switch4 (keyup)="0"> <br>
        </section>
        <h2 [hidden] ="switch1.value != switch1Number || switch2.value != switch2Number 
            || switch3.value != switch3Number || switch4.value != switch4Number">Congratulation <span>{{name.value}}</span>, you did it
    `
})
